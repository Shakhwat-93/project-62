            ...
            <section className="relative pt-24 pb-16 md:pt-52 md:pb-40 w-full z-20">
                <div className="max-w-7xl mx-auto px-6 text-center">
                    <div className="max-w-7xl mx-auto mb-12 md:mb-16">
                        <h1
                            ref={titleRef}
                            className="text-4xl md:text-7xl font-bold tracking-tight mb-6 md:mb-8 leading-[1.1] md:leading-tight text-white drop-shadow-sm font-display mx-auto max-w-7xl opacity-0"
                        ...
                        <p
                            ref={textRef}
                            className="text-base md:text-xl text-white mb-8 md:mb-12 max-w-3xl mx-auto font-normal leading-relaxed opacity-0"
                            style={{ textWrap: 'balance' }}
                        >
